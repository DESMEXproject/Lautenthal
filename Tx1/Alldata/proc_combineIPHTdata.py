...
data2 = CSEMData(datafile="Tx1_2/*.mat", txPos=txpos)
data4 = CSEMData(datafile="Tx1_4/*.mat", txPos=txpos)
data8 = CSEMData(datafile="Tx1_8/*.mat", txPos=txpos)
data32 = CSEMData(datafile="Tx1_32/*.mat", txPos=txpos)
# %% Combining the datas
