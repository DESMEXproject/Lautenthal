...
data4 = CSEMData(datafile="Tx2_4/*.mat", txPos=txpos)
data8 = CSEMData(datafile="Tx2_8/*.mat", txPos=txpos)
data32 = CSEMData(datafile="Tx2_32/*.mat", txPos=txpos)
# %% Combining the datas
